...
public class SpawnTierTwoScrolls implements MenuItem {
	...
	public void execute(Player plr, ClickType click) {
        ItemStack i1 = EnchantMechanics.t2_white_scroll.clone();
        ItemStack i2 = EnchantMechanics.t2_armor_scroll.clone();
        ItemStack i3 = EnchantMechanics.t2_wep_scroll.clone();
