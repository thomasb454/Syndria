...
public class ItemGenerators {
    ...
    public static ItemStack LeggingsGenerator(int tier, boolean reroll, ItemStack original) {
        ...
        /*
         * int hp_regen_chance = 0; int hp_increase_chance = 0; int energy_regen_chance = 0;
         */
        int block_chance = 0;
        int dodge_chance = 0;
        int thorns_chance = 0;
        ...
        /*
         * if(r.nextInt(100) <= energy_regen_chance){ energy_regen = true; energy_regen_percent = r.nextInt(energy_regen_max - energy_regen_min) +
         * energy_regen_min; }
         */
        ...
        if (reroll == true && original != null) {
            ...
            if (oarmor_data.contains("energy_regen")) {
                int energy_regen_val = Integer.parseInt(oarmor_data.substring(oarmor_data.indexOf("energy_regen=") + 13,
                        oarmor_data.indexOf("@energy_regen_split@")));
                hp_regen = false;
                energy_regen = true;
        ...
        /*
         * if(hp_regen == true){ armor_data += "ls=" + hp_regen_percent + ":"; armor_name = "Lifestealing " + armor_name; armor_description += red.toString() +
         * "LIFE STEAL: " + hp_regen_percent + "%,"; // hp_regen == .split(":")[2] }
         * 
         * 
         * if(block == true){ armor_data += "crit=" + block_percent + ":"; armor_name = "Deadly " + armor_name; armor_description += red.toString() +
         * "CRITICAL HIT: " + block_percent + "%,"; }
         * 
         * 
         * if(hp_increase == true){ armor_data += "edmg=" + element_dmg_type + "," + element_dmg_amount + ":";
         * 
         * if(dodge == true){ armor_name = armor_name + " " + element_dmg_type.substring(0, 1).toUpperCase() + element_dmg_type.substring(1,
         * element_dmg_type.length()); } if(dodge == false){ armor_name = armor_name + " of " + element_dmg_type.substring(0, 1).toUpperCase() +
         * element_dmg_type.substring(1, element_dmg_type.length()); }
         * 
         * armor_description += red.toString() + element_dmg_type.toUpperCase() + " DMG: +" + element_dmg_amount + ","; // hp_increase ==
         * .split(":")[3].split(",")[1] // edmg=fire,3 }
         */
    ...
    public static ItemStack SwordGenorator(Material m, boolean reroll, ItemStack original) {
        Random r = new Random();
        boolean life_steal = false, elemental_dmg = false, knockback = false, crit_hit = false, pure_dmg = false, armor_pen = false, blind = false/*
                                                                                                                                                   * ,
                                                                                                                                                   * specific_dmg
                                                                                                                                                   * = false
                                                                                                                                                   */;
