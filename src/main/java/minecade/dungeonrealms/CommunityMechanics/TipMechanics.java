...
public class TipMechanics implements Listener {
	public static CommunityMechanics plugin;
	
	public TipMechanics(CommunityMechanics instance) {
		plugin = instance;
	}
	...
	public void loadTips() {
		try {
			File file = new File(Hive.rootDir+"/plugins/CommunityMechanics/tips.txt");
			if(!(file.exists())) {
				file.createNewFile();
			}
