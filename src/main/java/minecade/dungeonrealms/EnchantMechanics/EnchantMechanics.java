package minecade.dungeonrealms.EnchantMechanics;
...
import minecade.dungeonrealms.EnchantMechanics.commands.CommandDREnchant;
...
public class EnchantMechanics implements Listener {
	...
	public static ItemStack t1_wep_scroll = ItemMechanics.signNewCustomItem(Material.EMPTY_MAP, (short) 1, ChatColor.WHITE.toString() + "" + ChatColor.BOLD.toString() + "Scroll:" + ChatColor.WHITE.toString() + " Enchant Wooden Weapon", ChatColor.RED.toString() + "+5% DMG" + "," + ChatColor.GRAY.toString() + ChatColor.ITALIC.toString() + "Weapon will VANISH if enchant above +3 FAILS.");
	
	public static ItemStack t2_wep_scroll = ItemMechanics.signNewCustomItem(Material.EMPTY_MAP, (short) 1, ChatColor.WHITE.toString() + "" + ChatColor.BOLD.toString() + "Scroll:" + ChatColor.GREEN.toString() + " Enchant Stone Weapon", ChatColor.RED.toString() + "+5% DMG" + "," + ChatColor.GRAY.toString() + ChatColor.ITALIC.toString() + "Weapon will VANISH if enchant above +3 FAILS.");
	
	public static ItemStack t3_wep_scroll = ItemMechanics.signNewCustomItem(Material.EMPTY_MAP, (short) 1, ChatColor.WHITE.toString() + "" + ChatColor.BOLD.toString() + "Scroll:" + ChatColor.AQUA.toString() + " Enchant Iron Weapon", ChatColor.RED.toString() + "+5% DMG" + "," + ChatColor.GRAY.toString() + ChatColor.ITALIC.toString() + "Weapon will VANISH if enchant above +3 FAILS.");
	
	public static ItemStack t4_wep_scroll = ItemMechanics.signNewCustomItem(Material.EMPTY_MAP, (short) 1, ChatColor.WHITE.toString() + "" + ChatColor.BOLD.toString() + "Scroll:" + ChatColor.LIGHT_PURPLE.toString() + " Enchant Diamond Weapon", ChatColor.RED.toString() + "+5% DMG" + "," + ChatColor.GRAY.toString() + ChatColor.ITALIC.toString() + "Weapon will VANISH if enchant above +3 FAILS.");
	
	public static ItemStack t5_wep_scroll = ItemMechanics.signNewCustomItem(Material.EMPTY_MAP, (short) 1, ChatColor.WHITE.toString() + "" + ChatColor.BOLD.toString() + "Scroll:" + ChatColor.YELLOW.toString() + " Enchant Gold Weapon", ChatColor.RED.toString() + "+5% DMG" + "," + ChatColor.GRAY.toString() + ChatColor.ITALIC.toString() + "Weapon will VANISH if enchant above +3 FAILS.");
	
	// ARMOR
	
	public static ItemStack t1_armor_scroll = ItemMechanics.signNewCustomItem(Material.EMPTY_MAP, (short) 1, ChatColor.WHITE.toString() + "" + ChatColor.BOLD.toString() + "Scroll:" + ChatColor.WHITE.toString() + " Enchant Leather Armor", ChatColor.RED.toString() + "+5% HP" + "," + ChatColor.RED.toString() + "+5% HP REGEN" + "," + ChatColor.GRAY.toString() + "      - OR -    " + "," + ChatColor.RED.toString() + "+1% ENERGY REGEN" + "," + ChatColor.GRAY.toString() + ChatColor.ITALIC.toString() + "Armor will VANISH if enchant above +3 FAILS.");
	
	public static ItemStack t2_armor_scroll = ItemMechanics.signNewCustomItem(Material.EMPTY_MAP, (short) 1, ChatColor.WHITE.toString() + "" + ChatColor.BOLD.toString() + "Scroll:" + ChatColor.GREEN.toString() + " Enchant Chainmail Armor", ChatColor.RED.toString() + "+5% HP" + "," + ChatColor.RED.toString() + "+5% HP REGEN" + "," + ChatColor.GRAY.toString() + "      - OR -    " + "," + ChatColor.RED.toString() + "+1% ENERGY REGEN" + "," + ChatColor.GRAY.toString() + ChatColor.ITALIC.toString() + "Armor will VANISH if enchant above +3 FAILS.");
	
	public static ItemStack t3_armor_scroll = ItemMechanics.signNewCustomItem(Material.EMPTY_MAP, (short) 1, ChatColor.WHITE.toString() + "" + ChatColor.BOLD.toString() + "Scroll:" + ChatColor.AQUA.toString() + " Enchant Iron Armor", ChatColor.RED.toString() + "+5% HP" + "," + ChatColor.RED.toString() + "+5% HP REGEN" + "," + ChatColor.GRAY.toString() + "      - OR -    " + "," + ChatColor.RED.toString() + "+1% ENERGY REGEN" + "," + ChatColor.GRAY.toString() + ChatColor.ITALIC.toString() + "Armor will VANISH if enchant above +3 FAILS.");
	
	public static ItemStack t4_armor_scroll = ItemMechanics.signNewCustomItem(Material.EMPTY_MAP, (short) 1, ChatColor.WHITE.toString() + "" + ChatColor.BOLD.toString() + "Scroll:" + ChatColor.LIGHT_PURPLE.toString() + " Enchant Diamond Armor", ChatColor.RED.toString() + "+5% HP" + "," + ChatColor.RED.toString() + "+5% HP REGEN" + "," + ChatColor.GRAY.toString() + "      - OR -    " + "," + ChatColor.RED.toString() + "+1% ENERGY REGEN" + "," + ChatColor.GRAY.toString() + ChatColor.ITALIC.toString() + "Armor will VANISH if enchant above +3 FAILS.");
	
	public static ItemStack t5_armor_scroll = ItemMechanics.signNewCustomItem(Material.EMPTY_MAP, (short) 1, ChatColor.WHITE.toString() + "" + ChatColor.BOLD.toString() + "Scroll:" + ChatColor.YELLOW.toString() + " Enchant Gold Armor", ChatColor.RED.toString() + "+5% HP" + "," + ChatColor.RED.toString() + "+5% HP REGEN" + "," + ChatColor.GRAY.toString() + "      - OR -    " + "," + ChatColor.RED.toString() + "+1% ENERGY REGEN" + "," + ChatColor.GRAY.toString() + ChatColor.ITALIC.toString() + "Armor will VANISH if enchant above +3 FAILS.");
	
	// PROTECTION
	
	public static ItemStack t1_white_scroll = ItemMechanics.signNewCustomItem(Material.EMPTY_MAP, (short) 1, ChatColor.WHITE.toString() + "" + ChatColor.BOLD.toString() + "White Scroll:" + ChatColor.WHITE.toString() + " Protect Leather/Wood Equipment", ChatColor.GRAY.toString() + ChatColor.ITALIC.toString() + "Apply to any T1 item to " + ChatColor.UNDERLINE + "prevent" + ChatColor.GRAY.toString() + " it" + "," + ChatColor.GRAY.toString() + ChatColor.ITALIC.toString() + "from being destroyed if the next" + "," + ChatColor.GRAY.toString() + ChatColor.ITALIC.toString() + "enchantment scroll (up to +8) fails.");
	
	public static ItemStack t2_white_scroll = ItemMechanics.signNewCustomItem(Material.EMPTY_MAP, (short) 1, ChatColor.WHITE.toString() + "" + ChatColor.BOLD.toString() + "White Scroll:" + ChatColor.GREEN.toString() + " Protect Stone/Chainmail Equipment", ChatColor.GRAY.toString() + ChatColor.ITALIC.toString() + "Apply to any T2 item to " + ChatColor.UNDERLINE + "prevent" + ChatColor.GRAY.toString() + " it" + "," + ChatColor.GRAY.toString() + ChatColor.ITALIC.toString() + "from being destroyed if the next" + "," + ChatColor.GRAY.toString() + ChatColor.ITALIC.toString() + "enchantment scroll (up to +8) fails.");
	
	public static ItemStack t3_white_scroll = ItemMechanics.signNewCustomItem(Material.EMPTY_MAP, (short) 1, ChatColor.WHITE.toString() + "" + ChatColor.BOLD.toString() + "White Scroll:" + ChatColor.AQUA.toString() + " Protect Iron Equipment", ChatColor.GRAY.toString() + ChatColor.ITALIC.toString() + "Apply to any T3 item to " + ChatColor.UNDERLINE + "prevent" + ChatColor.GRAY.toString() + " it" + "," + ChatColor.GRAY.toString() + ChatColor.ITALIC.toString() + "from being destroyed if the next" + "," + ChatColor.GRAY.toString() + ChatColor.ITALIC.toString() + "enchantment scroll (up to +8) fails.");
	...
	static Enchantment customEnchant = null;
	...
	public static Enchantment getCustomEnchant() {
	...
	public boolean isCorrectScroll(ItemStack scroll, ItemStack in_slot) {
		...
		if(scroll_type.contains("weapon")) {
			if(!in_raw_name.contains("axe") && !in_raw_name.contains("sword") && !in_raw_name.contains("bow") && !in_raw_name.contains("spade") && !in_raw_name.contains("hoe")) { return false; }
		}
		if(scroll_type.contains("armor")) {
			if(!in_raw_name.contains("boot") && !in_raw_name.contains("helmet") && !in_raw_name.contains("leg") && !in_raw_name.contains("chest")) { return false; }
		}
	...
	public static void addGlow(org.bukkit.inventory.ItemStack stack) {
		stack.addUnsafeEnchantment(getCustomEnchant(), 1);
	}
	...
	public void onScrollUse(InventoryClickEvent e) {
		...
		if(isEnchantScroll(cursor) && !(ProfessionMechanics.isSkillItem(in_slot)) && (ItemMechanics.isArmor(in_slot) || !ItemMechanics.getDamageData(in_slot).equalsIgnoreCase("no"))) {
			...
			if(win == true) {
				...
				/*
				 * Firework fw = (Firework) p.getWorld().spawnEntity(p.getLocation(), EntityType.FIREWORK); FireworkMeta fwm = fw.getFireworkMeta(); Random r =
				 * new Random(); FireworkEffect effect =
				 * FireworkEffect.builder().flicker(false).withColor(Color.BLACK).withFade(Color.GRAY).with(Type.BURST).trail(true).build();
				 * fwm.addEffect(effect); fwm.setPower(0); fw.setFireworkMeta(fwm);
				 */
			}
